...
typedef Dbgu at91sam9g25_dbgu_regs_t;
...
static int dbgu_read(int minor)
{
    ...
    dbgu = (at91sam9g25_dbgu_regs_t *)console_entry->ulCtrlPort1;
...
static void dbgu_init(int minor)
{
    ...
    /* Configure baudrate */
    dbgu->DBGU_BRGR = (at91sam9g25_get_mck() / 16) / BSP_get_baud();
